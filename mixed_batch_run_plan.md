...
This is exploratory run evidence. The final Project One analysis does not rely on this batch for dataset-level conclusions.

The Fleet dashboard dataset checked on July 7, 2026 shows the main analysis scope directly: 257 tasks, 712 total sessions, 658 scored sessions, 220 scored tasks, 7.6% overall pass rate, and 0.08 overall average score.
